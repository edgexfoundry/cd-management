...
summary = 'A Python script that generates edgex-compose/compose-builder/.env file with the latest versions for a given release'
url = 'https://github.com/edgexfoundry/cd-management/tree/edgex-compose-builder'
version = '0.0.1'
default_task = [
    'clean',
    'analyze',
...
def set_properties(project):
    ...
    project.set_property('distutils_console_scripts',
                         ['env-builder = envbuilder.cli:main',
                          'docker-image = envbuilder.images:main'])
