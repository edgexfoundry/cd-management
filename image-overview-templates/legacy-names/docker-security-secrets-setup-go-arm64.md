...
$$./common/version-hanoi.md |
        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/security-secrets-setup/Dockerfile)
...
This image contains the **ARM64 version** of the initialization / setup service used to establish the secrets.
