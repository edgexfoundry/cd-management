...
- Edinburgh
    - 1.0.1        - [Dockerfile](https://github.com/edgexfoundry/security-secret-store/blob/edinburgh/Dockerfile.vault-worker)
...
**ARCHIVED**
This image contains the **ARM64 version** of EdgeX secretstore initialization service (aka edgex-vault-worker). It is no longer used or supported.
