...
- Hanoi
    - 1.3.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/security-proxy-setup/Dockerfile)
...
**ARCHIVED**
This image contains the **ARM64 version** of initialization / setup service used to establish the security proxy (API gateway) as well as OAuth2 and JWT authentication tokes.  It was replaced by [docker-security-proxy-setup-go](https://hub.docker.com/r/edgexfoundry/docker-security-proxy-setup-go).  It is no longer used or supported.
...
[source repository](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/security-proxy-setup/Attribution.txt).