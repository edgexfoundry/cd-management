...
- Hanoi
    - 1.3.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/core-data/Dockerfile)
...
This image contains the **ARM64 version** of [core data](https://docs.edgexfoundry.org/1.3/microservices/core/data/Ch-CoreData/) service and all of its base configuration.
