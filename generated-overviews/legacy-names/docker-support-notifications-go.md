...
- Hanoi
    - 1.3.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/support-notifications/Dockerfile)
...
This image contains the [support notifications](https://docs.edgexfoundry.org/1.3/microservices/support/notifications/Ch-AlertsNotifications/) service and all of its base configuration.
