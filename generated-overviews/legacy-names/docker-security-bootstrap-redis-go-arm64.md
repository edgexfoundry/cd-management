...
- Hanoi
    - 1.3.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/security-bootstrap-redis/Dockerfile)
...
This image contains the **ARM64 version** of the initialization / setup service used to read the Redis password from Vault and set it in Redis.
...
[source repository](https://github.com/edgexfoundry/edgex-go/blob/hanoi/cmd/security-bootstrap-redis/Attribution.txt).