...
- Napa
    - 3.1.0        - [Dockerfile](https://github.com/edgexfoundry/device-onvif-camera/blob/v3.1.0/Dockerfile)
- Minnesota
    - 3.0.0        - [Dockerfile](https://github.com/edgexfoundry/device-onvif-camera/blob/v3.0.0/Dockerfile)
- Levski
    - 2.3.1
        - [Dockerfile](https://github.com/edgexfoundry/device-onvif-camera/blob/v2.3.1/Dockerfile)
- Kamakura
    - 2.2.0        - [Dockerfile](https://github.com/edgexfoundry/device-onvif-camera/blob/v2.2.0/Dockerfile)
