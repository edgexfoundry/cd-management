...
- Kamakura
    - 2.2.0        - [Dockerfile](https://github.com/edgexfoundry/device-snmp-go/blob/v2.2.0/Dockerfile)
- Jakarta ([LTS](https://wiki.edgexfoundry.org/pages/viewpage.action?pageId=69173332))
    - 2.1.0        - [Dockerfile](https://github.com/edgexfoundry/device-snmp-go/blob/v2.1.0/Dockerfile)
- Ireland
    - 2.0.0        - [Dockerfile](https://github.com/edgexfoundry/device-snmp-go/blob/v2.0.0/Dockerfile)
