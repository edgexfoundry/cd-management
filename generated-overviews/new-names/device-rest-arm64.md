...
- Ireland
    - 2.0.0        - [Dockerfile](https://github.com/edgexfoundry/device-rest-go/blob/v1.3.2/Dockerfile)
...
[source repository](https://github.com/edgexfoundry/device-rest-go/blob/v1.3.2/Attribution.txt).
