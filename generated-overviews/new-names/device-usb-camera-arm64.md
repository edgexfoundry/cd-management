...
- Napa
    - 3.1.0        - [Dockerfile](https://github.com/edgexfoundry/device-usb-camera/blob/v3.1.0/Dockerfile)
- Minnesota
    - 3.0.0        - [Dockerfile](https://github.com/edgexfoundry/device-usb-camera/blob/v3.0.0/Dockerfile)
- Levski
    - 2.3.1
