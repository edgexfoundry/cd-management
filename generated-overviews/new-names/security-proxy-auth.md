...
- Napa
    - 3.1.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/v3.1.0/cmd/security-proxy-auth/Dockerfile)
- Minnesota
    - 3.0.0        - [Dockerfile](https://github.com/edgexfoundry/edgex-go/blob/v3.0.0/cmd/security-proxy-auth/Dockerfile)
